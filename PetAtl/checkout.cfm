  ...
  <div class="container">
		...
		<div class="col-md-9 content_right">
		   ...
		   <div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
					...
					<a class="cbp-vm-icon cbp-vm-add" href="login.cfm" style="margin-left: 200px;height: 50px;width: 150px;text-align: center;padding: 15px;font-size:1em;">Place Order</a>
				</div>
