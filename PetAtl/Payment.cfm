		  	  ...
		  	  <form> 
				 <div class="register-top-grid">
					<h3>PAYMENT</h3>
					 ...
					 <div>
						<span> Shipping Address</span>
							<div>
								<span>Apartment Number<label>*</label></span>
								<input type="text"> 
							</div>
							<div>
					...
					<div class="register-top-grid">
					 	<h3>CARD DETAILS</h3>
					 	<div>
							<span>Card Type<label>*</label></span>
							<select>
					 	...
					 	<div>
								<span>Name on Card<label>*</label></span>
								<input type="text"> 
						</div>
						<div>
				   ...
				   <div class="register-top-grid">
					<h3> Order Amount</h3>
						<div>
							<span>CartSubtotal<label>$45.88</label></span> 
							<span>Tax<label>$3.8</label></span> 
							<span>Grand total<label>$49.68</label></span> 
							
						</div>
				  <div class="clearfix"> </div>

				<div class="register-but">
			<cfoutput>	   <form action="new4.cfm" name="custidform">
				   	<input type="hidden" name="usrid3" value=#userid#>
